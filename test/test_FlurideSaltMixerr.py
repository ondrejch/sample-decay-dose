...
# --- Tests for the base FluorideSalt class ---
...
def test_flibeuf4salt_init():
    salt = FlibeUF4Salt(
        name="TestFlibeUF4",
        temperature=950,
        u_enr_weight={'u-235': 0.2, 'u-238': 0.8},
        u_impurities_weight={'Al': 1e-5},
        UF4=0.22,
        Li7_enr=0.999
    )
...
def test_flibeuf4salt_direct_admixture():
    ...
    """
    salt = FlibeUF4Salt(
        name="DirectAdmixture",
        temperature=900,
        u_enr_weight=None,
        u_impurities_weight=None,
        UF4=0.20,
...
def admixture_salt():
    ...
    return FlibeUF4AdmixtureSalt(
        name="AdmixtureTest",
        temperature=950,
        u_enr_weight={'u-235': 0.2, 'u-238': 0.8},
        u_impurities_weight={'Ni-58': 5e-6},
        UF4=0.20,
        admixtures={
            'LuF3': {'mol_frac': 0.01, 'enrichment': {176: 1.0}},
            'YbF3': {'mol_frac': 0.02}
        },
        Li7_enr=0.9999
    )
