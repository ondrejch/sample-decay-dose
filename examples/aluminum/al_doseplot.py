...
plt.legend()
plt.tight_layout()
plt.savefig(f'dose_g_aluminum.png', dpi=1000)

plt.xscale('log')
plt.yscale('log')
plt.savefig(f'dose_g_aluminum-loglog.png', dpi=1000)
...
plt.legend()
plt.tight_layout()
plt.savefig(f'dose_b_aluminum.png', dpi=1000)

plt.xscale('log')
plt.yscale('log')
plt.savefig(f'dose_b_aluminum-loglog.png', dpi=1000)
plt.close()
